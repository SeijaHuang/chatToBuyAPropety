...
SESSION_RESTORE_INSTRUCTION = (
    ...
    "Sentence 1: Naturally acknowledge the user is returning — do NOT use the words "
    "'database', 'cache', 'session', or any technical terms. "
    "Sentence 2: Briefly recap the key requirements already collected in plain language; "
